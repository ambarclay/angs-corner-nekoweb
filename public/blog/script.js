...
let postsArray = [
  ...
  ["posts/2026-02-07-i-saw-Iron-Lung.html"],
  ["posts/2026-02-03-where-have-i-been.html"],
  ["posts/2025-06-10-how-i-learned-to-love-reading-again.html"],
...
let recentPostListHTML = "<h3 class='theme-1'>recent posts:</h3><ul>";
...
if (document.getElementById("nextprev2")) {
  document.getElementById("nextprev2").innerHTML = nextprevHTML;
}
if (document.getElementById("postlistdiv")) {
  document.getElementById("postlistdiv").innerHTML = postListHTML;
}
if (document.getElementById("postlistdiv2")) {
  document.getElementById("postlistdiv2").innerHTML = postListHTML;
}
if (document.getElementById("recentpostlistdiv")) {
  document.getElementById("recentpostlistdiv").innerHTML = recentPostListHTML;
}
if (document.getElementById("recentpostlistdiv2")) {
  document.getElementById("recentpostlistdiv2").innerHTML = recentPostListHTML;
}
...
if (document.getElementById("blogTitleH1-2")) {
  document.getElementById("blogTitleH1-2").innerHTML = blogTitle;
}
if (document.getElementById("postTitleH1")) {
  document.getElementById("postTitleH1").innerHTML = currentPostTitle;
}
if (document.getElementById("postTitleH1-2")) {
  document.getElementById("postTitleH1-2").innerHTML = currentPostTitle;
}
if (document.getElementById("postDate")) {
  document.getElementById("postDate").innerHTML = niceDate.toLowerCase();
}
if (document.getElementById("postDate2")) {
  document.getElementById("postDate2").innerHTML = niceDate.toLowerCase();
}
...
//deleted code that i dont wanna get rid of yet

// +
// "<p>" +
// blogName +
// " is written by <a href='" +
// authorLink +
// "'>" +
// authorName +
// "</a>, built with <a href='https://zonelets.net/'>zonelets</a>"
